...
print('INICIO_LINEA***línea de texto # 1***FIN_LINEA')
print('INICIO_LINEA***línea de texto # 2***FIN_LINEA')
print('INICIO_LINEA***línea de texto # 3***FIN_LINEA')
print('INICIO_LINEA***línea de texto # 4***FIN_LINEA')
print('INICIO_LINEA***línea de texto # 5***FIN_LINEA')
...
print('Esta es una primera línea-AQUI PUEDO ESCRIBIR LO QUE SEA!!')
print('Aquí va a otra-AQUI PUEDO ESCRIBIR LO QUE SEA!!')
