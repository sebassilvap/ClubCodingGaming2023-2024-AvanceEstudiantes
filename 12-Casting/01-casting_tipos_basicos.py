...
print( var_5 , '=>' , var_5_to_float , '\t', type(var_5_to_float) )
...
#print( int(var_1) )
#! ValueError: invalid literal for int() with base 10: 'hola python'

#print( float(var_1) )
#! ValueError: could not convert string to float: 'hola python'
...
cadena_3 = str(var_3) # True
cadena_5 = str(var_5) # None

# index / posición -1 => se refiere a la última posición
# de un elemento iterable

print( cadena_3[0], cadena_3[-1] ) # T e
print( cadena_5[0], cadena_5[-1] ) # N e