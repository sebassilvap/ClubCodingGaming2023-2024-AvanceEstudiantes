...
# vamos a suponer que siempre las notas van a ser ingresadas
# del 0 al 20 (incluidos)

# => el orden va de arriba a abajo
...
if numero < 4:
    print('número menor a 4')
elif numero < 1:
    print('número menor a 1')
elif numero < 3:
    print('número menor a 3')
...
'''
- los 2 códigos funcionan, pero arrojan distintos resultados
...
##  (A) inicia con if y termina con else | if - else
##  (B) inicia con if y termina con elif | if - elif
##  (C) inicia con if y termina con el inicio de un nuevo if | if (1) - if(2)
...
if temp < 0:
    print('frío extremo!')
elif temp >0 and temp < 15: # definir un rango con and
...
# los 2 funcionan de la misma manera
# => pero más recomendable y elegante con el else
...
if len(str(numero)) == 1:
    ...
    print('número tiene 2 dígitos')
elif len(str(numero)) == 3:
    print('número tiene 3 dígitos')
else: #! para el resto de los casos
    print('numero tiene bastantes dígitos!!')
# end if
